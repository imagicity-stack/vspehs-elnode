...
/**
 * Photo picker that uploads to the storage bucket (or falls back to a local
 * data URL in demo mode) and returns the resulting URL via onChange.
 */
    ...
    <div className="flex items-center gap-4">
      ...
      <div className="min-w-0">
        ...
        <p className="mt-1 text-xs text-slate-400">
          {isStorageConfigured ? "JPG/PNG, up to 5 MB." : "Demo mode — saved to this browser only."}
        </p>
